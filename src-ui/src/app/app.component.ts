        ...
        if (
          ...
          if (
            ...
            this.toastService.show({
              content: $localize`Document ${status.filename} was added to Jipange.`,
              delay: 10000,
    ...
    this.newDocumentSubscription = this.consumerStatusService
      ...
      .subscribe((status) => {
        ...
        if (
          ...
          this.toastService.show({
            content: $localize`Document ${status.filename} is being processed by Jipange.`,
            delay: 5000,
          })
        }
      })
    ...
    this.tourService.initialize(
      [
        ...
        },
        {
          ...
          content: $localize`Drag-and-drop documents here to start uploading or place them in the consume folder. You can also drag-and-drop documents anywhere on all other pages of the web app. Once you do, Jipange will start training its machine learning algorithms.`,
          route: '/dashboard',
        },
        {
